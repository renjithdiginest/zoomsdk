...
export enum ZoomVideoSDKVirtualBackgroundDataType {
  None = 'ZoomVideoSDKLiveTranscription_OperationType_None',
...
export enum ZoomVideoSdkCRCProtocolType {
...
export class ZoomVideoSdk implements ZoomVideoSdkType {
  ...
  cleanup = RNZoomVideoSdk.cleanup;

  acceptRecordingConsent = RNZoomVideoSdk.acceptRecordingConsent;

  declineRecordingConsent = RNZoomVideoSdk.declineRecordingConsent;

  getRecordingConsentType = RNZoomVideoSdk.getRecordingConsentType;

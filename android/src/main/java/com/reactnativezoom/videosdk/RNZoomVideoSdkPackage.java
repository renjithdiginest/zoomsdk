...
public class RNZoomVideoSdkPackage implements ReactPackage {
  ...
  public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
    ...
    modules.add(new RNZoomVideoSdkRemoteCameraControlHelperModule(reactContext));
    modules.add(new RNZoomVideoSdkVirtualBackgroundHelperModule(reactContext));
    modules.add(new RNZoomVideoSdkVirtualBackgroundItemModule(reactContext));
    modules.add(new RNZoomVideoSdkILiveTranscriptionMessageInfoModule(reactContext));
    modules.add(new RNZoomVideoSdkCRCHelperModule(reactContext));
    return modules;
  }

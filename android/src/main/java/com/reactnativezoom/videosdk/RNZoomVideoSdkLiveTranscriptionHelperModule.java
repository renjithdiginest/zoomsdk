...
public class RNZoomVideoSdkLiveTranscriptionHelperModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void isAllowViewHistoryTranslationMessageEnabled(Promise promise) {
    promise.resolve(getLiveTranscriptionHelper().isAllowViewHistoryTranslationMessageEnabled());
  }

  @ReactMethod
  public void getHistoryTranslationMessageList(Promise promise) {
    ...
    promise.resolve(RNZoomVideoSdkILiveTranscriptionMessageInfoModule.mapMessageInfoArray(messageInfoList));
  }

  @ReactMethod
  public void isReceiveSpokenLanguageContentEnabled(Promise promise) {
    promise.resolve(getLiveTranscriptionHelper().isReceiveSpokenLanguageContentEnabled());
  }

  @ReactMethod
  public void enableReceiveSpokenLanguageContent(boolean enable, Promise promise) {
    reactContext.getCurrentActivity().runOnUiThread(new Runnable() {
      @Override
      public void run() {
        promise.resolve(RNZoomVideoSDKErrors.valueOf(getLiveTranscriptionHelper().enableReceiveSpokenLanguageContent(enable)));
      }
    });
  }

...
export class ZoomVideoSdkUser implements ZoomVideoSdkUserType {
  ...
  async getUserVolume(userId: string, isSharing: boolean) {
    return await RNZoomVideoSdkUser.getUserVolume(userId, isSharing);
  }

  async setUserVolume(userId: string, isSharing: boolean, volume: number) {
    return await RNZoomVideoSdkUser.setUserVolume(userId, volume, isSharing);
  }

  async canSetUserVolume(userId: string, isSharing: boolean) {
    return await RNZoomVideoSdkUser.canSetUserVolume(userId, isSharing);
  }

  async hasIndividualRecordingConsent(userId: string) {
